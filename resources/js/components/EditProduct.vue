...
export default {
    ...
    mounted() {
        ...
        for(let productVariantPrice of product.product_variant_prices){
            ...
            let title2 = productVariantPrice.product_variant_two ? "/" + productVariantPrice.product_variant_two.variant  : '';

            let title3 = productVariantPrice.product_variant_three  ? "/" +  productVariantPrice.product_variant_three.variant : '';
            this.product_variant_prices.push({
                    product_variant_one: variant_one_id,
                    product_variant_two: variant_two_id,
                    product_variant_three: variant_three_id,
